...
use ArrayAccess;
use Countable;
use Liberty\System\Type\Comparable;
use Liberty\System\Type\Equatable;
use ReflectionClass;
...
final class Validate
{
     ...
     *
     * @return ($value is empty ? false : true)
     */
    ...
    public static function isUrn(mixed $value): bool
    {
        ...
        if (str_starts_with((string) $value, 'urn:urn:')) {
            return false;
        }
     ...
     *
     * @return ($value is string|bool|int|float|Stringable|null ? true : false)
     */
     ...
     *
     * @return ($value is array|Traversable ? true : false)
     */
     ...
     *
     * @return ($value is array|ArrayAccess ? true : false)
     */
     ...
     *
     * @return ($value is Comparable ? true : false)
     */
     ...
     *
     * @return ($value is Equatable ? true : false)
     */
    ...
    {
        if (!is_object($value)) {
            $exists = self::classExists($value) || self::interfaceExists($value);
            if (!$exists) {
                return false;
            }
            $value = (string) $value;
     ...
     *
     * @return ($scheme is non-empty-string ? bool : false)
     */
     ...
     *
     * @return ($authority is non-empty-string ? bool : true)
     */
     ...
     *
     * @return ($path is non-empty-string ? bool : true)
     */
     ...
     *
     * @return ($query is non-empty-string ? bool : true)
     */
     ...
     *
     * @return ($fragment is non-empty-string ? bool : true)
     */
     ...
     *
     * @return ($userinfo is null ? true : bool)
     */
     ...
     *
     * @return ($host is non-empty-string ? bool : true)
     */
